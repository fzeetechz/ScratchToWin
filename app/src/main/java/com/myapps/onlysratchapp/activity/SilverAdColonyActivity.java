...
public class SilverAdColonyActivity extends AppCompatActivity implements ScratchListener, LoginContract.View  {
      ...
      /*  // Ad specific options to be sent with request
        ...
        listener = new AdColonyInterstitialListener() {
            ...
            public void onRequestFilled(AdColonyInterstitial ad) {
                ...
                SilverAdColonyActivity.this.ad = ad;
...
*/
    ...
    private void showDialogPoints(final int addOrNoAddValue, final String points, final int counter) {
        final Dialog dialog = new Dialog(SilverAdColonyActivity.this);
        ...
        if (Constant.isNetworkAvailable(SilverAdColonyActivity.this)) {
                ...
                public void onClick(View view) {
                    ...
                    if (addOrNoAddValue == 1) {
                        if (points.equals("0")) {
                            ...
                            Constant.setString(SilverAdColonyActivity.this, Constant.SCRATCH_COUNT_SILVER, current_counter);
                            setScratchCount(Constant.getString(SilverAdColonyActivity.this, Constant.SCRATCH_COUNT_SILVER));
                            dialog.dismiss();
                        } else {
                            String current_counter = String.valueOf(counter - 1);
                            Constant.setString(SilverAdColonyActivity.this, Constant.SCRATCH_COUNT_SILVER, current_counter);
                            ...
                            try {
                                ...
                                poiints = finalPoint;
                                Constant.addPoints(SilverAdColonyActivity.this, finalPoint, 0);
                                setPointsText();
    ...
    public void showDailog() {
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                if (poiints != 0) {
                    String po = Constant.getString(SilverAdColonyActivity.this, Constant.USER_POINTS);
                    if (po.equals("")) {
                        po = "0";
                    }
                    int current_Points = Integer.parseInt(po);
                    int finalPoints = current_Points - poiints;
                    Constant.setString(SilverAdColonyActivity.this, Constant.USER_POINTS, String.valueOf(finalPoints));
                    Intent serviceIntent = new Intent(SilverAdColonyActivity.this, PointsService.class);
                    serviceIntent.putExtra("points", Constant.getString(SilverAdColonyActivity.this, Constant.USER_POINTS));
                    SilverAdColonyActivity.this.startService(serviceIntent);
                    setPointsText();
                }
            }
        });
    ...
    public void onScratchProgress(@NonNull ScratchCardLayout scratchCardLayout, int i) {
        if (scratch_first) {
            ...
            if (Constant.isNetworkAvailable(this)) {
                ...
                Constant.showInternetErrorDialog(SilverAdColonyActivity.this, getResources().getString(R.string.no_internet_connection));
            }
        }
    }
