...
public class PlatinumAdColonyActivity extends AppCompatActivity implements ScratchListener, LoginContract.View  {
      ...
      /*  // Ad specific options to be sent with request
        ...
        listener = new AdColonyInterstitialListener() {
            ...
            public void onRequestFilled(AdColonyInterstitial ad) {
                ...
                PlatinumAdColonyActivity.this.ad = ad;
...
*/
    ...
    private void onInit() {
        ...
        String scratchCount = Constant.getString(PlatinumAdColonyActivity.this, Constant.SCRATCH_COUNT_PLATINUM);
        ...
        if (scratchCount.equals("")) {
            ...
            String last_date = Constant.getString(PlatinumAdColonyActivity.this, Constant.LAST_DATE_SCRATCH_PLATINUM);
            ...
            if (last_date.equals("")) {
                ...
                Constant.setString(PlatinumAdColonyActivity.this, Constant.SCRATCH_COUNT_PLATINUM, getResources().getString(R.string.scratch_count));
                Constant.setString(PlatinumAdColonyActivity.this, Constant.LAST_DATE_SCRATCH_PLATINUM, currentDate);
            } else {
                ...
                try {
                    ...
                    if (difference_In_Days > 0) {
                        Constant.setString(PlatinumAdColonyActivity.this, Constant.LAST_DATE_SCRATCH_PLATINUM, currentDate);
                        Constant.setString(PlatinumAdColonyActivity.this, Constant.SCRATCH_COUNT_PLATINUM, getResources().getString(R.string.scratch_count));
                        setScratchCount(Constant.getString(PlatinumAdColonyActivity.this, Constant.SCRATCH_COUNT_PLATINUM));
    ...
    private void showDialogPoints(final int addOrNoAddValue, final String points, final int counter) {
        final Dialog dialog = new Dialog(PlatinumAdColonyActivity.this);
        ...
        if (Constant.isNetworkAvailable(PlatinumAdColonyActivity.this)) {
                ...
                public void onClick(View view) {
                    ...
                    if (addOrNoAddValue == 1) {
                        if (points.equals("0")) {
                            ...
                            Constant.setString(PlatinumAdColonyActivity.this, Constant.SCRATCH_COUNT_PLATINUM, current_counter);
                            setScratchCount(Constant.getString(PlatinumAdColonyActivity.this, Constant.SCRATCH_COUNT_PLATINUM));
                            dialog.dismiss();
                        } else {
                            String current_counter = String.valueOf(counter - 1);
                            ...
                            try {
                                ...
                                poiints = finalPoint;
                                Constant.addPoints(PlatinumAdColonyActivity.this, finalPoint, 0);
                                setPointsText();
            ...
            Constant.showInternetErrorDialog(PlatinumAdColonyActivity.this, getResources().getString(R.string.no_internet_connection));
        }
        dialog.show();
    }
    ...
    public void showDailog() {
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                if (poiints != 0) {
                    String po = Constant.getString(PlatinumAdColonyActivity.this, Constant.USER_POINTS);
                    if (po.equals("")) {
                        po = "0";
                    }
                    int current_Points = Integer.parseInt(po);
                    int finalPoints = current_Points - poiints;
                    Constant.setString(PlatinumAdColonyActivity.this, Constant.USER_POINTS, String.valueOf(finalPoints));
                    Intent serviceIntent = new Intent(PlatinumAdColonyActivity.this, PointsService.class);
                    serviceIntent.putExtra("points", Constant.getString(PlatinumAdColonyActivity.this, Constant.USER_POINTS));
                    PlatinumAdColonyActivity.this.startService(serviceIntent);
                    setPointsText();
                }
            }
        });
