...
public class GoldFBActivity extends AppCompatActivity implements ScratchListener, LoginContract.View  {
...
*/
    ...
    private void showDialogPoints(final int addOrNoAddValue, final String points, final int counter) {
        ...
        if (Constant.isNetworkAvailable(this)) {
                ...
                public void onClick(View view) {
                    ...
                    if (addOrNoAddValue == 1) {
                        if (points.equals("0")) {
                            ...
                            Constant.setString(GoldFBActivity.this, Constant.SCRATCH_COUNT_GOLD, current_counter);
                            setScratchCount(Constant.getString(GoldFBActivity.this, Constant.SCRATCH_COUNT_GOLD));
                            dialog.dismiss();
                        } else {
                            String current_counter = String.valueOf(counter - 1);
                            Constant.setString(GoldFBActivity.this, Constant.SCRATCH_COUNT_GOLD, current_counter);
                            ...
                            try {
                                ...
                                poiints = finalPoint;
                                Constant.addPoints(GoldFBActivity.this, finalPoint, 0);
                                setPointsText();
            ...
            Constant.showInternetErrorDialog(GoldFBActivity.this, getResources().getString(R.string.no_internet_connection));
        }
        dialog.show();
    }
    ...
    public void showDailog() {
        final Dialog dialog = new Dialog(GoldFBActivity.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.show_points_dialog);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog.setCancelable(false);
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                if (poiints != 0) {
                    String po = Constant.getString(GoldFBActivity.this, Constant.USER_POINTS);
                    if (po.equals("")) {
                        po = "0";
                    }
                    int current_Points = Integer.parseInt(po);
                    int finalPoints = current_Points - poiints;
                    Constant.setString(GoldFBActivity.this, Constant.USER_POINTS, String.valueOf(finalPoints));
                    Intent serviceIntent = new Intent(GoldFBActivity.this, PointsService.class);
                    serviceIntent.putExtra("points", Constant.getString(GoldFBActivity.this, Constant.USER_POINTS));
                    GoldFBActivity.this.startService(serviceIntent);
                    setPointsText();
                }
            }
        });
    ...
    private void showInterstitialAds() {
        ...
        AbstractAdListener adListener = new AbstractAdListener() {
            ...
            public void onError(Ad ad, AdError error) {
                ...
                Toast.makeText(GoldFBActivity.this, "Error loading ad: " + error.getErrorMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void showRewardedVideo() {
        ...
        RewardedVideoAdListener rewardedVideoAdListener = new RewardedVideoAdListener() {
            @Override
            public void onError(Ad ad, AdError error) {
                Toast.makeText(GoldFBActivity.this, "Sorry, error on loading the ad. Try again!", Toast.LENGTH_SHORT).show();
          progressDialog.dismiss();
            }
            ...
            public void onRewardedVideoCompleted() {
                Toast.makeText(GoldFBActivity.this, "Ad completed, now give reward to user", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
                String count = scratch_count_textView.getText().toString();
                String[] counteee = count.split("=", 2);
                String ran = counteee[1];
