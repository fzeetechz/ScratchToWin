...
public class GoldInmobiActivity extends AppCompatActivity implements ScratchListener, LoginContract.View  {
        ...
        InMobiSdk.init(this, "3d3b7103f8ea46d5bc4728887004006d", consent, new SdkInitializationListener() {
            ...
            public void onInitializationComplete(@Nullable Error error) {
                if (error == null) {
                    ...
                    Toast.makeText(GoldInmobiActivity.this, "InMobi SDK is not initialized." +
...
*/
    ...
    private void showDialogPoints(final int addOrNoAddValue, final String points, final int counter) {
        ...
        if (Constant.isNetworkAvailable(this)) {
                ...
                public void onClick(View view) {
                    ...
                    if (addOrNoAddValue == 1) {
                        if (points.equals("0")) {
                            ...
                            Constant.setString(GoldInmobiActivity.this, Constant.SCRATCH_COUNT_GOLD, current_counter);
                            setScratchCount(Constant.getString(GoldInmobiActivity.this, Constant.SCRATCH_COUNT_GOLD));
                            dialog.dismiss();
                        } else {
                            String current_counter = String.valueOf(counter - 1);
                            Constant.setString(GoldInmobiActivity.this, Constant.SCRATCH_COUNT_GOLD, current_counter);
                            ...
                            try {
                                ...
                                poiints = finalPoint;
                                Constant.addPoints(GoldInmobiActivity.this, finalPoint, 0);
                                setPointsText();
            ...
            Constant.showInternetErrorDialog(GoldInmobiActivity.this, getResources().getString(R.string.no_internet_connection));
        }
        dialog.show();
    }
    ...
    public void showDailog() {
        final Dialog dialog = new Dialog(GoldInmobiActivity.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.show_points_dialog);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog.setCancelable(false);
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                if (poiints != 0) {
                    String po = Constant.getString(GoldInmobiActivity.this, Constant.USER_POINTS);
                    if (po.equals("")) {
                        po = "0";
                    }
                    int current_Points = Integer.parseInt(po);
                    int finalPoints = current_Points - poiints;
                    Constant.setString(GoldInmobiActivity.this, Constant.USER_POINTS, String.valueOf(finalPoints));
                    Intent serviceIntent = new Intent(GoldInmobiActivity.this, PointsService.class);
                    serviceIntent.putExtra("points", Constant.getString(GoldInmobiActivity.this, Constant.USER_POINTS));
                    GoldInmobiActivity.this.startService(serviceIntent);
                    setPointsText();
                }
            }
        });
    ...
    private void setupInterstitial() {
        mInterstitialAd = new InMobiInterstitial(GoldInmobiActivity.this, 1670421656344L,
