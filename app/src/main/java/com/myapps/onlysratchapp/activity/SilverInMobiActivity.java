...
public class SilverInMobiActivity extends AppCompatActivity implements ScratchListener, LoginContract.View  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InMobiSdk.init(this, "3d3b7103f8ea46d5bc4728887004006d", consent, new SdkInitializationListener() {
            @Override
            public void onInitializationComplete(@Nullable Error error) {
                if (error == null) {
                    ...
                    Log.e(TAG, "InMobi SDK Initialization failed: " + error.getMessage());
                            ...
                            Toast.makeText(SilverInMobiActivity.this, "InMobi SDK is not initialized." +
...
*/
    ...
    private void showDialogPoints(final int addOrNoAddValue, final String points, final int counter) {
        final Dialog dialog = new Dialog(SilverInMobiActivity.this);
        ...
        if (Constant.isNetworkAvailable(SilverInMobiActivity.this)) {
                ...
                public void onClick(View view) {
                    ...
                    if (addOrNoAddValue == 1) {
                        if (points.equals("0")) {
                            ...
                            Constant.setString(SilverInMobiActivity.this, Constant.SCRATCH_COUNT_SILVER, current_counter);
                            setScratchCount(Constant.getString(SilverInMobiActivity.this, Constant.SCRATCH_COUNT_SILVER));
                            dialog.dismiss();
                        } else {
                            String current_counter = String.valueOf(counter - 1);
                            Constant.setString(SilverInMobiActivity.this, Constant.SCRATCH_COUNT_SILVER, current_counter);
                            ...
                            try {
                                ...
                                poiints = finalPoint;
                                Constant.addPoints(SilverInMobiActivity.this, finalPoint, 0);
                                setPointsText();
    ...
    public void showDailog() {
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                if (poiints != 0) {
                    String po = Constant.getString(SilverInMobiActivity.this, Constant.USER_POINTS);
                    if (po.equals("")) {
                        po = "0";
                    }
                    int current_Points = Integer.parseInt(po);
                    int finalPoints = current_Points - poiints;
                    Constant.setString(SilverInMobiActivity.this, Constant.USER_POINTS, String.valueOf(finalPoints));
                    Intent serviceIntent = new Intent(SilverInMobiActivity.this, PointsService.class);
                    serviceIntent.putExtra("points", Constant.getString(SilverInMobiActivity.this, Constant.USER_POINTS));
                    SilverInMobiActivity.this.startService(serviceIntent);
                    setPointsText();
                }
            }
        });
    ...
    public void onScratchProgress(@NonNull ScratchCardLayout scratchCardLayout, int i) {
        if (scratch_first) {
            ...
            if (Constant.isNetworkAvailable(this)) {
                ...
                Constant.showInternetErrorDialog(SilverInMobiActivity.this, getResources().getString(R.string.no_internet_connection));
            }
        }
    }
    ...
    private void setupInterstitial() {
        mInterstitialAd = new InMobiInterstitial(SilverInMobiActivity.this, 1670421656344L,
