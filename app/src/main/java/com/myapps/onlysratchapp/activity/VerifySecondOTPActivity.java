...
public class VerifySecondOTPActivity extends AppCompatActivity implements  LoginContract.View{
   ...
   // private ACProgressFlower alertDialog;
    ...
    private void initView() {
        ...
        tvRefername=findViewById(R.id.text_refer);
        ...
        if (newuser.equals("Y"))
        {
            referEditText.setVisibility(View.VISIBLE);
            btnVerifyRefer.setVisibility(View.VISIBLE);
        }else {
       ...
       /* alertDialog = new ACProgressFlower.Builder(this)
        ...
        referEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (referEditText.getText().toString().length() == 7) {
        ...
        btnVerifyRefer.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void onClick(View view) {
                if (Constant.isNetworkAvailable(getApplicationContext())) {
                    ...
                    if (otp.length() == 0) {
                        ...
                        hideKeyboard(VerifySecondOTPActivity.this);
                        // showProgressDialog();
                        presenter.verifySecondOTP(mobile, otp,refercode, VerifySecondOTPActivity.this);
                        // signInWithEmailandPassword(name, mobile);
                    }
                } else {
                    Constant.showInternetErrorDialog(VerifySecondOTPActivity.this, getResources().getString(R.string.no_internet_connection));
                }
            }
        });
    }
    ...
    @Override
        ...
        if (referUserResponse.getUser().equals("N"))
        {
            ...
            tvRefername.setVisibility(View.GONE);
        }else {
            tvRefername.setVisibility(View.VISIBLE);
            tvRefername.setText(referUserResponse.getUser());
