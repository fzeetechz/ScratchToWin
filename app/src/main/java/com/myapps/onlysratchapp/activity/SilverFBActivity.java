...
public class SilverFBActivity extends AppCompatActivity implements ScratchListener, LoginContract.View  {
...
*/
    ...
    private void showDialogPoints(final int addOrNoAddValue, final String points, final int counter) {
        final Dialog dialog = new Dialog(SilverFBActivity.this);
        ...
        if (Constant.isNetworkAvailable(SilverFBActivity.this)) {
                ...
                public void onClick(View view) {
                    ...
                    if (addOrNoAddValue == 1) {
                        if (points.equals("0")) {
                            ...
                            Constant.setString(SilverFBActivity.this, Constant.SCRATCH_COUNT_SILVER, current_counter);
                            setScratchCount(Constant.getString(SilverFBActivity.this, Constant.SCRATCH_COUNT_SILVER));
                            dialog.dismiss();
                        } else {
                            String current_counter = String.valueOf(counter - 1);
                            Constant.setString(SilverFBActivity.this, Constant.SCRATCH_COUNT_SILVER, current_counter);
                            ...
                            try {
                                ...
                                poiints = finalPoint;
                                Constant.addPoints(SilverFBActivity.this, finalPoint, 0);
                                setPointsText();
    ...
    public void showDailog() {
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                if (poiints != 0) {
                    String po = Constant.getString(SilverFBActivity.this, Constant.USER_POINTS);
                    if (po.equals("")) {
                        po = "0";
                    }
                    int current_Points = Integer.parseInt(po);
                    int finalPoints = current_Points - poiints;
                    Constant.setString(SilverFBActivity.this, Constant.USER_POINTS, String.valueOf(finalPoints));
                    Intent serviceIntent = new Intent(SilverFBActivity.this, PointsService.class);
                    serviceIntent.putExtra("points", Constant.getString(SilverFBActivity.this, Constant.USER_POINTS));
                    SilverFBActivity.this.startService(serviceIntent);
                    setPointsText();
                }
            }
        });
    ...
    public void onScratchProgress(@NonNull ScratchCardLayout scratchCardLayout, int i) {
        if (scratch_first) {
            ...
            if (Constant.isNetworkAvailable(this)) {
                ...
                Constant.showInternetErrorDialog(SilverFBActivity.this, getResources().getString(R.string.no_internet_connection));
            }
        }
    }
    ...
    private void showInterstitialAds() {
        ...
        AbstractAdListener adListener = new AbstractAdListener() {
            ...
            public void onError(Ad ad, AdError error) {
                ...
                Toast.makeText(SilverFBActivity.this, "Error loading ad: " + error.getErrorMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void showRewardedVideo() {
        ...
        RewardedVideoAdListener rewardedVideoAdListener = new RewardedVideoAdListener() {
            @Override
            public void onError(Ad ad, AdError error) {
                Toast.makeText(SilverFBActivity.this, "Sorry, error on loading the ad. Try again! "+error.getErrorMessage(), Toast.LENGTH_SHORT).show();
         Log.v("ADTAG", error.getErrorMessage());
          progressDialog.dismiss();
            }
            ...
            public void onRewardedVideoCompleted() {
                Toast.makeText(SilverFBActivity.this, "Ad completed, now give reward to user", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
                String count = scratch_count_textView.getText().toString();
                String[] counteee = count.split("=", 2);
                String ran = counteee[1];
