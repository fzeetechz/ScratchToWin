...
public class VerifyFirstOTPActivity extends AppCompatActivity implements  LoginContract.View{
   ...
   // private ACProgressFlower alertDialog;
    ...
    private String mobileno, newuser;
    @Override
            ...
            public void onClick(View view) {
                if (Constant.isNetworkAvailable(getApplicationContext())) {
                    ...
                    if (otp.length() == 0) {
                        ...
                        hideKeyboard(VerifyFirstOTPActivity.this);
                        // showProgressDialog();
                        presenter.verifyFirstOTP(mobile, otp, VerifyFirstOTPActivity.this);
                        // signInWithEmailandPassword(name, mobile);
                    }
                } else {
                    Constant.showInternetErrorDialog(VerifyFirstOTPActivity.this, getResources().getString(R.string.no_internet_connection));
                }
            }
        });
    }
