...
public class GoldAppLovinActivity extends AppCompatActivity implements ScratchListener, LoginContract.View , AppLovinAdLoadListener, AppLovinAdVideoPlaybackListener, AppLovinAdDisplayListener, AppLovinAdClickListener, AppLovinAdRewardListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppLovinSdk.initializeSdk( this, new AppLovinSdk.SdkInitializationListener() {
            ...
            public void onSdkInitialized(final AppLovinSdkConfiguration configuration)
            {
                ...
                rewardedAd.preload( GoldAppLovinActivity.this );

                interstitialAd = AppLovinInterstitialAd.create( AppLovinSdk.getInstance( GoldAppLovinActivity.this ), GoldAppLovinActivity.this );
                interstitialAd.setAdDisplayListener( GoldAppLovinActivity.this );
                interstitialAd.setAdClickListener( GoldAppLovinActivity.this );
                interstitialAd.setAdVideoPlaybackListener( GoldAppLovinActivity.this ); // This will only ever be used if you have video ads enabled.
                AppLovinSdk.getInstance( getApplicationContext() ).getAdService().loadNextAd( AppLovinAdSize.INTERSTITIAL, GoldAppLovinActivity.this );
...
*/
    ...
    private void showDialogPoints(final int addOrNoAddValue, final String points, final int counter) {
        ...
        if (Constant.isNetworkAvailable(this)) {
                ...
                public void onClick(View view) {
                    ...
                    if (addOrNoAddValue == 1) {
                        if (points.equals("0")) {
                            ...
                            Constant.setString(GoldAppLovinActivity.this, Constant.SCRATCH_COUNT_GOLD, current_counter);
                            setScratchCount(Constant.getString(GoldAppLovinActivity.this, Constant.SCRATCH_COUNT_GOLD));
                            dialog.dismiss();
                        } else {
                            String current_counter = String.valueOf(counter - 1);
                            Constant.setString(GoldAppLovinActivity.this, Constant.SCRATCH_COUNT_GOLD, current_counter);
                            ...
                            try {
                                ...
                                poiints = finalPoint;
                                Constant.addPoints(GoldAppLovinActivity.this, finalPoint, 0);
                                setPointsText();
            ...
            Constant.showInternetErrorDialog(GoldAppLovinActivity.this, getResources().getString(R.string.no_internet_connection));
        }
        dialog.show();
    }
    ...
    public void showDailog() {
        final Dialog dialog = new Dialog(GoldAppLovinActivity.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.show_points_dialog);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog.setCancelable(false);
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                if (poiints != 0) {
                    String po = Constant.getString(GoldAppLovinActivity.this, Constant.USER_POINTS);
                    if (po.equals("")) {
                        po = "0";
                    }
                    int current_Points = Integer.parseInt(po);
                    int finalPoints = current_Points - poiints;
                    Constant.setString(GoldAppLovinActivity.this, Constant.USER_POINTS, String.valueOf(finalPoints));
                    Intent serviceIntent = new Intent(GoldAppLovinActivity.this, PointsService.class);
                    serviceIntent.putExtra("points", Constant.getString(GoldAppLovinActivity.this, Constant.USER_POINTS));
                    GoldAppLovinActivity.this.startService(serviceIntent);
                    setPointsText();
                }
            }
        });
