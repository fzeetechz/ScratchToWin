...
public class SilverApplovinActivity extends AppCompatActivity implements ScratchListener, LoginContract.View, AppLovinAdLoadListener, AppLovinAdVideoPlaybackListener, AppLovinAdDisplayListener, AppLovinAdClickListener, AppLovinAdRewardListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppLovinSdk.initializeSdk( this, new AppLovinSdk.SdkInitializationListener() {
            ...
            public void onSdkInitialized(final AppLovinSdkConfiguration configuration)
            {
                ...
                rewardedAd.preload( SilverApplovinActivity.this );

                interstitialAd = AppLovinInterstitialAd.create( AppLovinSdk.getInstance( SilverApplovinActivity.this ), SilverApplovinActivity.this );
                interstitialAd.setAdDisplayListener( SilverApplovinActivity.this );
                interstitialAd.setAdClickListener( SilverApplovinActivity.this );
                interstitialAd.setAdVideoPlaybackListener( SilverApplovinActivity.this ); // This will only ever be used if you have video ads enabled.
                AppLovinSdk.getInstance( getApplicationContext() ).getAdService().loadNextAd( AppLovinAdSize.INTERSTITIAL, SilverApplovinActivity.this );
...
*/
    ...
    private void showDialogPoints(final int addOrNoAddValue, final String points, final int counter) {
        final Dialog dialog = new Dialog(SilverApplovinActivity.this);
        ...
        if (Constant.isNetworkAvailable(SilverApplovinActivity.this)) {
                ...
                public void onClick(View view) {
                    ...
                    if (addOrNoAddValue == 1) {
                        if (points.equals("0")) {
                            ...
                            Constant.setString(SilverApplovinActivity.this, Constant.SCRATCH_COUNT_SILVER, current_counter);
                            setScratchCount(Constant.getString(SilverApplovinActivity.this, Constant.SCRATCH_COUNT_SILVER));
                            dialog.dismiss();
                        } else {
                            String current_counter = String.valueOf(counter - 1);
                            Constant.setString(SilverApplovinActivity.this, Constant.SCRATCH_COUNT_SILVER, current_counter);
                            ...
                            try {
                                ...
                                poiints = finalPoint;
                                Constant.addPoints(SilverApplovinActivity.this, finalPoint, 0);
                                setPointsText();
    ...
    public void showDailog() {
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                if (poiints != 0) {
                    String po = Constant.getString(SilverApplovinActivity.this, Constant.USER_POINTS);
                    if (po.equals("")) {
                        po = "0";
                    }
                    int current_Points = Integer.parseInt(po);
                    int finalPoints = current_Points - poiints;
                    Constant.setString(SilverApplovinActivity.this, Constant.USER_POINTS, String.valueOf(finalPoints));
                    Intent serviceIntent = new Intent(SilverApplovinActivity.this, PointsService.class);
                    serviceIntent.putExtra("points", Constant.getString(SilverApplovinActivity.this, Constant.USER_POINTS));
                    SilverApplovinActivity.this.startService(serviceIntent);
                    setPointsText();
                }
            }
        });
    ...
    public void onScratchProgress(@NonNull ScratchCardLayout scratchCardLayout, int i) {
        if (scratch_first) {
            ...
            if (Constant.isNetworkAvailable(this)) {
                ...
                Constant.showInternetErrorDialog(SilverApplovinActivity.this, getResources().getString(R.string.no_internet_connection));
            }
        }
    }
