...
public class PuzzleMainActivity extends AppCompatActivity implements PuzzleUtilsAwv.Listener {
    public PuzzleUtilsAwv mwebView;
    public PuzzleUtilsManager manager;
    public RelativeLayout relativeLayout;
    public Button btnNoInternetConnection;
    private PuzzleGdpr gdpr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mwebView = (PuzzleUtilsAwv) findViewById(R.id.myWebView);
        mwebView.setListener(this, this);
        mwebView.setMixedContentAllowed(false);
        manager = new PuzzleUtilsManager(this);
        manager.init();
    ...
    public void openQuitDialog() {
        ...
        alert = new androidx.appcompat.app.AlertDialog.Builder(PuzzleMainActivity.this);
