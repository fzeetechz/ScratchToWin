package com.myapps.onlysratchapp.services;
...
public class PointsService extends Service {
    ...
    private void addDataToFirebase(final String points) {
        ...
        thread = new Thread() {
            @Override
            public void run() {
                Constant.setString(App.Companion.getContext(), Constant.LAST_TIME_ADD_TO_SERVER, "");
                String tag_json_obj = "json_login_req";
                Map<String, String> params = new HashMap<String, String>();
                params.put("update_point", "any");
                params.put("new_point", points);
                params.put("user_id", Constant.getString(App.Companion.getContext(), Constant.USER_ID));
                ...
                CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status) {
                                Constant.setString(App.Companion.getContext(), Constant.LAST_TIME_ADD_TO_SERVER, "add");
                            } else {
                                Constant.setString(App.Companion.getContext(), Constant.LAST_TIME_ADD_TO_SERVER, "");
                            }
                            stopSelf();
