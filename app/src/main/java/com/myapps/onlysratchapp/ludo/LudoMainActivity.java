package com.myapps.onlysratchapp.ludo;
...
public class LudoMainActivity extends AppCompatActivity implements UtilsAwv.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ludomain);
        init_screen();
    ...
    public void checkConnection(Bundle savedInstanceState){
        ...
        boolean isConnected;
        String url = "file:///android_asset/indexludo.html";
        if (needConnection) {
    ...
    public void openQuitDialog() {
        ...
        alert = new androidx.appcompat.app.AlertDialog.Builder(LudoMainActivity.this);
